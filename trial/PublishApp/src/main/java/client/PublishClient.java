...
/**
 * Jersey REST client generated for REST resource:JakartaEE10Resource [pub]<br>
 * USAGE:
 * <pre>
...
public class PublishClient {
    ...
    public PublishClient() {
        ...
        webTarget = client.target(BASE_URI).path("pub");
    }
    ...
    public void addSubscription(String title) throws ClientErrorException {
        webTarget.path(java.text.MessageFormat.format("addsubscription/{0}/[type}", new Object[]{title})).request().post(null);
    }
    ...
    public void removeSubscriptionsToCustomer(Object requestEntity, String cid) throws ClientErrorException {
        webTarget.path(java.text.MessageFormat.format("remsubstocust/{0}", new Object[]{cid})).request(jakarta.ws.rs.core.MediaType.APPLICATION_JSON).post(jakarta.ws.rs.client.Entity.entity(requestEntity, jakarta.ws.rs.core.MediaType.APPLICATION_JSON));
    }
    ...
    public void addAddressOfCustomer(String street, String city, String state, String zip, String cid) throws ClientErrorException {
        webTarget.path(java.text.MessageFormat.format("addaddressofcust/{0}/{1}/{2}/{3}/{4}", new Object[]{street, city, state, zip, cid})).request().post(null);
    }
