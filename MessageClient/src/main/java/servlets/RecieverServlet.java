 ...
 * @author kamlendu
 */
@WebServlet(name = "RecieverServlet", urlPatterns = {"/RecieverServlet"})
public class RecieverServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet RecieverServlet</title>");
            out.println("</head>");
            out.println("<body>");
            try{
              Properties p = new Properties();
                ...
                MessageConsumer mp = qsession.createConsumer(queue);
                
                qcon.start();
                
               String str = ((TextMessage)mp.receive()).getText();
           
                
                out.println("Message Recieved : "+ str);
        }
        ...
        catch(JMSException|NamingException  je)
        {
            ...
            out.println("<h1>Servlet RecieverServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
