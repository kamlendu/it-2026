...
@MessageDriven(activationConfig = {
    @ActivationConfigProperty(propertyName = "clientId", propertyValue = "jms/itqueue1"),
...
public class FirstQueueBean implements MessageListener {
    ...
    public void onMessage(Message message) {
        ...
        System.out.println("First Queue Bean recieved : "+ msg);
                ...
                txt.setText("Send By FirstQueue : Message Sent to Servlet...");
                mp.send(txt);
        }
