<%@ page import=" java.math.BigDecimal, ejb.ConverterLocal, javax.naming.InitialContext"%>

<%!
	
        
	ConverterLocal converter = null;
	...
	converter = (ConverterLocal) ic.lookup("java:global/CurrencyApp/ConverterBean");
		}
		catch (Exception ex)
		{
