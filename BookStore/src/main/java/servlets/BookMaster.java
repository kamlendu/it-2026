 ...
 * BookMaster.java
 *
 * Created on July 30, 2016, 1:19 PM
 */

/**
 *
 * @author Dr. Kamlendu Pandey
 * @version
 */
...
@WebServlet(name = "BookMaster", urlPatterns = "/BookMaster")
    ...
    public void service(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException {
        ...
        if("D".equals(request.getParameter("hidMode")) && con != null) {
            try {
                ...
                response.sendRedirect("/BookStore/BookMaster");
            } catch(Exception e) {
        ...
        out.println("<FORM ACTION='/BookStore/BookMaster' METHOD='post' NAME='frmBook'>");
